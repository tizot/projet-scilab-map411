...
function [derX, derY, derT] = derivees(I1, I2)
    ...
    derX(2:N-1, 2:N-1) = (I1(2:N-1, 3:N) - I1(2:N-1, 2:N-1) + I1(3:N, 3:N) - I1(3:N, 2:N-1) + I2(2:N-1, 3:N) - I2(2:N-1, 2:N-1) + I2(3:N, 3:N) - I2(3:N, 2:N-1))/4;
    derY(2:N-1, 2:N-1) = (I1(3:N, 2:N-1) - I1(2:N-1, 2:N-1) + I1(3:N, 3:N) - I1(2:N-1, 3:N) + I2(3:N, 2:N-1) - I2(2:N-1, 2:N-1) + I2(3:N, 3:N) - I2(2:N-1, 3:N))/4;
    derT(2:N-1, 2:N-1) = (I2(2:N-1, 2:N-1) - I1(2:N-1, 2:N-1) + I2(3:N, 2:N-1) - I1(3:N, 2:N-1) + I2(3:N, 3:N) - I1(3:N, 3:N) + I2(2:N-1, 3:N) - I1(2:N-1, 3:N))/4;
